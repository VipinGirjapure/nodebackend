const hollywood = [
    {
        ...
        "urlToImage": "https://www.gannett-cdn.com/presto/2022/05/03/USAT/cf1a292e-ab30-43ee-a9e2-e018f09b307f-Doctor_Strange_2_exclusive.jpg?auto=webp&crop=3037,1708,x529,y0&format=pjpg&width=200",
        },
        {
        "source": {
          "name": "Deadline"
        ...
        "description": "Britney Spears decided o give fans a sneak peek at her wedding veil ahead of her upcoming nuptials to fiance Sam Asghari.",
        "publishedAt": "2022-05-08T03:48:57Z",
      },
      {
          "content": "Britney Spears decided o give fans a sneak peek at her wedding veil ahead of her upcoming nuptials to fiance Sam Asghari.\r\nThe princess of pop, 40, took to her Instagram on Saturday to share an ador… [+7500 chars]",
        "source": {
        ...
        "title": "David Leterman Pokes Fun at Dave Chappelle Attack: “How Many of You Would Like to Hit Me?” - Hollywood Reporter",
      ...
      {
          "content": "David Leterman took the stage for a Netflix Is a Joke Festival event Friday and appeared to respond to the recent attack on Dave Chappelle at the Hollywood Bowl.\r\nLetterman hosted a live comedy show… [+1982 chars]",
        "source": {
          "name": "Daily Mail"
        },
        "id": 6,
      ...
      },
      {
        ...
        "title": "Watch Pete DavidsonJoke About Kanye West Pulling A 'Mrs. Doubtfire' To See His Kids - HuffPost",
      ...
      {
          "content": "Comedian Pete Davidsonfired off a couple of jokes at Kanye Wests expense in a stand-up routine last week, including hoping the rapper would show up as Mrs. Doubtfire to see his four children with Ki… [+1561 chars]",
        "source": {
          "name": "TrekMovie"
        },
        "id": 11,
        ...
        "description": "The showrunner has also shared a video rom the first day of production on season 3.",
        ...
        "urlToImage": "https://s.yimg.com/ny/api/res/1.2/cqwPdvZgyJGmsvUWZ0Xs5g--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTY0MDtjZj13ZWJw/https://s.yimg.com/uu/api/res/1.2/CfkoY586zNeP8c9qzgjbiw--~B/aD02ODM7dz0xMDI1O2FwcGlkPXl0YWNoeW9u/https://media.zenfs.com/en/footwear_news_642/29d651edf9033a9f9f1b70a4133bc206",
        "publishedAt": "2022-05-08T00:45:44Z",
        "content": 'Dove Cameron is in the midst of a killer style evolution, swapping out her glam girl-next-door fare for a darker trendy style ripe with edgy rocker elements'},
        {
        "source": {
        ...
        "id": 15,
        "author": 'ELANA RUBIN',
        "title": "There May Be Another Friends Reunion Thanks to the 2021 Emmys ",
        "description": 'This is a big deal: The Friends cast just earned an Emmy nomination for their HBO Max special…and now we’re fully preparing to see them reunite in September at the awards show.',
        ...
        "urlToImage": 'https://akns-images.eonline.com/eol_images/Entire_Site/2021426/rs_1024x1024-210526153417-1024.4friends-cast-.jpg?fit=around%7C1024:1024&output-quality=90&crop=1024:1024;center,top',
        "publishedAt": "JUL 13, 2 0 21 10:35  PM",
        "content": 'Could we be any more excited about this news? Less than two months after the Friends cast delighted fans with their HBO Max reunion, the special has earned an Emmy nomination for Outstanding Variety Special.'
        },
        {
        "source": {
          "name": "The A.V. Club"
      ...
      {
          "content": "George Pérez has died. A legendary comics artist and writer whose work defined the looks of many of both DC and Marvels biggest comics from the mid-70 onward, Pérez was celebrated for runs on Avenge… [+4408 chars]",
        "source": {
          "name": "TMZ"
        },
        "id": 17,
        ...
        "publishedAt": "2022-05-07 T 21:10:46 Z",
        "content": "Netflix chiefs are said tobe exasperated by the decision of the Duke and Duchess of Sussex to give bombshell interviews to rival television networks despite having a multi-million-dollar deal with t… [+2669 chars]"
            
      }
  ];
  const GetHollywoodPageData = (req, res) => {
    res.json({
      data: hollywood,
    });
  };
  
  const GetHollywoodProduct = (req, res) => {
    const id = req.params.productid;
  
    const dataForId = hollywood.find((ele) => ele.id == id);
