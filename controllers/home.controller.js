const home = [
      ...
      "publishedAt": "2022-05-08 T 10:15:10 Z",
      ...
      "publishedAt": "May 08, 2022 3:46 pm IST",
      "content": `In Delhi Clashes, Court Blasts Police For 'Utter Failure' To Stop March
      ...
      "id": 3,
      "author": "Shruti Tomar",
      "title": "Indore fire that killed 7 started by man over a breakup, arrested: Cops ",
      ...
      "content": "A 28-year-old man, who allegedly set on fire the building in Indore that claimed seven lives and injured nine others on Saturday, has been arrested, the Madhya Pradesh police said on Sunday. Police said the man wanted to get back at a woman living in the building who was reportedly in a relationship with him but broke up with him and decided to marry someone else. Shubham Dixit alias Sanjay, 28, was arrested late at night on Saturday from Lohamandi. He tried to flee and injured his leg and a hand. Police admitted him to the hospital and later arrested him, said Tehzeeb Qazi, police station in-charge, Vijay Nagar. "
      },
      {
      "source": {
        "name": "Hindustan Times"
      ...
      "description": 'NASA re-synthesised the soundwaves to human hearing range by “scaling them upward by 57 or 58 octaves” above their real pitch to create the sonification.',
      ...
      "urlToImage": `https://www.financialexpress.com/wp-content/uploads/2022/05/Black-Hole-Reuters.jpg`,
      "publishedAt": "2022-05-08T07:35:11Z",
      "content": `NASA has released audio of the black hole at the centre of the Perseus galaxy, more than 200 million lightyears away from Earth. The sound waves were recorded by the space telescope, the Chandra X-ray observatory, as astronomical data and then translated into sound.

      “Since 2003, the black hole at the centre of the Perseus galaxy cluster has been associated with sound,” NASA said in a statement.“This is because astronomers discovered that pressure waves sent out by the black hole caused ripples in the cluster’s hot gas that could be translated into a note – one that humans cannot hear some 57 octaves below middle C.”`
      },
      {
      "source": {
        "name": "Hindustan Times"
...
const GetSingleProduct = (req, res) => {
  ...
  const dataForId = home.find((ele) => ele.id == id);
  res.json({
    message: "Success",
    data: dataForId,
  });
